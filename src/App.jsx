                    ...
                    < section id="taxi" className="bg-black py-28 px-6" >
                        ...
                        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                            ...
                            <div>
                                ...
                                <button
                                    onClick={() => setTaxiOpen(true)}
                                    className="mt-10 bg-red-600 px-8 py-4 rounded-2xl font-semibold hover:bg-red-700 transition"
                                >
                                    Reserve Taxi
                                </button>
                                ...
                                <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 w-full max-w-lg relative">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-red-600 py-4 rounded-xl font-bold hover:bg-red-700 transition"
                                        >
                                            Confirm Taxi
                                        </button>
